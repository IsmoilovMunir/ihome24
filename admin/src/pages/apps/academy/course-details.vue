                ...
                <div>
                  <VList class="card-list text-medium-emphasis">
                    <VListItem>
                      ...
                      <VListItemTitle>Уровень навыков: {{ courseDetails?.skillLevel }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Студенты: {{ courseDetails?.totalStudents }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Языки: {{ courseDetails?.language }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Субтитры: {{ courseDetails?.isCaptions }}</VListItemTitle>
                    </VListItem>
                  </VList>
                </div>
                ...
                <div>
                  <VList class="card-list text-medium-emphasis">
                    <VListItem>
                      ...
                      <VListItemTitle>Лекции: {{ courseDetails?.totalLectures }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Видео: {{ courseDetails?.length }}</VListItemTitle>
                    </VListItem>
                  </VList>
                </div>
              </div>
