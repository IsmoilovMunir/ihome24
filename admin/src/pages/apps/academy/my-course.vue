    ...
    <VCard class="mb-6">
      <VCardText class="py-12 position-relative">
        ...
        >
          ...
          >
            Образование, таланты и карьерные
            возможности. <span class="text-primary text-no-wrap"> Всё в одном месте.</span>
          </h4>
          <p class="text-center text-wrap text-body-1 mx-auto mb-0">
            Развивайте свои навыки с помощью самых надёжных онлайн-курсов и сертификатов по маркетингу, информационным технологиям, программированию и науке о данных.
          </p>
      ...
      <VRow>
        <VCol
          v-for="{ title, btnText, color, description, image } in [
            { title: 'Получите сертификат', description: 'Получите подходящую программу профессионального сертификата для вас.', btnText: 'Просмотреть программы', color: 'primary', image: boyAppAcademy },
            { title: 'Лучшие курсы', description: 'Запишитесь сейчас на самые популярные и лучшие курсы.', btnText: 'Просмотреть курсы', color: 'error', image: girlAppAcademy },
          ]"
          :key="title"
          cols="12"
          md="6"
          ...
          >
            <div class="d-flex flex-column align-center gap-y-4 h-100 justify-center">
              ...
              <h4 class="text-h4 font-weight-medium">
                Бесплатные курсы сегодня
              </h4>
              <p class="text-body-1 text-center mb-0">
                Мы предлагаем 284 бесплатных онлайн-курса от ведущих преподавателей и компаний, чтобы помочь вам начать или продвинуть свои карьерные навыки. Учитесь онлайн бесплатно и быстро уже сегодня!
              </p>
              <VBtn>Получить премиум курсы</VBtn>
            </div>
          </VCol>
          <VCol
            cols="12"
            ...
            >
              ...
              <VCardText>
                <h5 class="text-h5 mb-2">
                  Ваш первый урок пения
                </h5>
                <p class="text-body-1 mb-0">
                  Как и в любой другой художественной области, пение идеально подходит для самостоятельного обучения.
                </p>
              </VCardText>
            </VCard>
          </VCol>
          ...
          >
            ...
            >
              ...
              <VCardText>
                ...
                <p class="text-body-1 mb-0">
                  Акустическая гитара Fender - лучший выбор для начинающих и профессионалов.
                </p>
              </VCardText>
            </VCard>
          </VCol>
