      ...
      >
        <div class="pe-3">
          <h5 class="text-h5 mb-2">
            Добро пожаловать,<span class="text-h4"> Felecia 👋🏻 </span>
          </h5>
          ...
          >
            Ваш прогресс на этой неделе отличный. Продолжайте в том же духе
            и получайте много баллов!
          </div>

          <div class="d-flex justify-space-between flex-wrap gap-4 flex-column flex-md-row mt-4">
            <div
              v-for="{ title, value, icon, color } in [
                { title: 'Потрачено часов', value: '34h', icon: customLaptop, color: 'primary' },
                { title: 'Результаты тестов', value: '82%', icon: customLightbulb, color: 'info' },
                { title: 'Завершено курсов', value: '14', icon: customCheck, color: 'warning' },
              ]"
              :key="title"
            >
