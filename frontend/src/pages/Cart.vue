              ...
              <div class="flex items-center justify-between sm:justify-end gap-2 flex-wrap">
                <div class="flex items-center space-x-2">
                  <button
                    ...
                    class="px-2 py-1 md:px-3 md:py-1 border border-white/30 rounded text-white hover:bg-white/10 text-sm"
                  >
                    -
                  </button>
      ...
      <div class="lg:col-span-1">
        <div class="rounded-2xl shadow-md p-4 md:p-6 sticky top-20" style="background-color: #3A3331;">
          ...
          <router-link
            ...
            class="block w-full bg-[#3A3331] text-white py-3 rounded-2xl hover:bg-[#F47327]/50 active:bg-[#F47327]/50 transition-colors text-center font-semibold border-2 border-[#F47327]"
          >
            Оформить заказ
          </router-link>
          <button
